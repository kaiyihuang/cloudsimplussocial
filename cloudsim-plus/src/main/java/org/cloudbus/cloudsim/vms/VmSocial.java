 ...
 */
public class VmSocial extends CustomerEntityAbstract implements Vm {
    ...
    public void assignOwner(User owned)
    {
        this.owner = owned;
    }
     ...
     * @see #setDefaultStorageCapacity(long)
     */
    public VmSocial(final double mipsCapacity, final long numberOfPes, final CloudletScheduler cloudletScheduler) {
        this(-1, mipsCapacity, numberOfPes);
     ...
     * @see #setDefaultStorageCapacity(long)
     */
    public VmSocial(final long id, final double mipsCapacity, final long numberOfPes) {
